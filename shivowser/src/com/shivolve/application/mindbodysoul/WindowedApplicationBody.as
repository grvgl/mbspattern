package com.shivolve.application.mindbodysoul
{
	 ...
	 */
	public class WindowedApplicationBody extends MBSFlexBody implements IMBSBody
	{
		//protected var app:MBS_AS3_Examples;
		protected var app:WindowedApplication;
		public function WindowedApplicationBody(soul:IMBSSoul, mind:IMBSMind = null, app:WindowedApplication = null)
		{
			super(soul, mind);
			this.app = app;
